...
<!-- Global site tag (gtag.js) - Google Ads: 10990686132 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-10990686132"></script>
<script>
    ...
    gtag('js', new Date());
    gtag('config', 'AW-10990686132');
</script>


<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-178601809-8"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-178601809-8');
</script>

<!-- GA4:
ID DA MÉTRICA: G-LFKLY5V4X3 -->
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-LFKLY5V4X3"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-LFKLY5V4X3');
</script>
...
<script>
    function gtag_report_conversion(praca) {
        ...
        gtag('event', 'conversion', {
            'send_to': 'AW-10990686132/72ZLCI-3698DELSf4vgo',
...
<script>
    ...
    fbq('init', '677252743365765');
    fbq('track', 'PageView');
</script>

<noscript>
    <img height="1" width="1" src="https://www.facebook.com/tr?id='677252743365765&ev=PageView
&noscript=1" />
</noscript>
